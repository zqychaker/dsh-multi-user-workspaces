...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  User: 'public user record projection is owned by packages/identity/users/README.md',
  UserId: 'branded user identity is owned by packages/identity/users/README.md',
}
